...
public class Custre implements ModInitializer {
    ...
    static {
        STRIPPING_DIRECTORY = DirectoryHandler.appendToPath( CelibDirectories.RECIPE_DIRECTORY, "stripping" );
        STRIPPING_TEMPLATE_DIRECTORY = DirectoryHandler.appendToPath( CelibDirectories.TEMPLATE_DIRECTORY, "stripping" );

        vanillaTemplate = new HashMap<>() { {
